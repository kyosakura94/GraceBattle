...
public class EnemyStateMachine : MonoBehaviour {
    ...
    private IEnumerator TimeForAction() {
        ...
        for (int i = 0; i < BSM.PerformList.Count; i++)
        {
            if (BSM.PerformList[i].ChoosenAttack.Attacktype == "skill")
            {
            ...
            if (BSM.PerformList[i].ChoosenAttack.Attacktype == "skill1")
            {
                while (MoveTowardsEnemy(heroPosition))
                {
                    yield return null;
            ...
            if (BSM.PerformList[i].ChoosenAttack.Attacktype == "skill2")
            {
                while (MoveTowardsEnemy(heroPosition))
                {
                    yield return null;
            ...
            if (BSM.PerformList[i].ChoosenAttack.Attacktype == "skill3")
            {
